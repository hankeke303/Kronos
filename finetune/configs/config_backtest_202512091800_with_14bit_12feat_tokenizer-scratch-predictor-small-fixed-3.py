...
class Config:
    ...
    def __init__(self):
        ...
        self.run_id = "backtest_202512091800_with_14bit_12feat_tokenizer-scratch-predictor-small-fixed-3"
        ...
        # Miscellaneous
        self.seed = 300  # Global random seed for reproducibility.
        ...
        self.finetuned_predictor_path = "./outputs/models/finetune_predictor_demo_test_202512041503_predictor_12feature_14bit-2_tokloss0.0059/checkpoints/best_model"
