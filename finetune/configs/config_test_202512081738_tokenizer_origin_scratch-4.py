...
class Config:
    ...
    def __init__(self):
        ...
        self.run_id = "test_202512081738_tokenizer_origin_scratch-4"
        ...
        self.pretrained_tokenizer_path = "./outputs/models/finetune_tokenizer_demo_test_20251206_2331_tokenizer_origin_scratch-3/checkpoints/best_model"
