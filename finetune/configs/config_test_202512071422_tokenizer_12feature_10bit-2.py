...
class Config:
    ...
    def __init__(self):
        ...
        self.run_id = "test_202512071422_tokenizer_12feature_10bit-2"
        ...
        self.pretrained_tokenizer_path = "./outputs/models/finetune_tokenizer_demo_test_20251202_1536_tokenizer_12feature_10bit/checkpoints/best_model"
