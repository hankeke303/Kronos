...
class Config:
    ...
    def __init__(self):
        ...
        self.run_id = "test_202512301542_predictor_w_tokenizer12270306_lr2.5e-6_batch200_decay0.5"
        ...
        self.tokenizer_learning_rate = 2.5e-6
        self.predictor_learning_rate = 2.5e-6
