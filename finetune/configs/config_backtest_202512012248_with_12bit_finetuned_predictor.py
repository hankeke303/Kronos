...
class Config:
    ...
    def __init__(self):
        ...
        self.run_id = "backtest_202512012248_with_12bit_finetuned_predictor"
        ...
        # self.pretrained_tokenizer_path = "./outputs/models/finetune_tokenizer_demo_test_20251128_2002_tokenizer_s1bit12-2/checkpoints/best_model"
        ...
        self.finetuned_tokenizer_path = "./outputs/models/finetune_tokenizer_demo_test_20251130_1359_tokenizer_s1bit12-5-coslr-1e-5/checkpoints/best_model"
        ...
        self.finetuned_predictor_path = "./outputs/models/finetune_predictor_demo_test_202512011451_predictor_w_tokenizer11301359_l0072-2/checkpoints/best_model"
