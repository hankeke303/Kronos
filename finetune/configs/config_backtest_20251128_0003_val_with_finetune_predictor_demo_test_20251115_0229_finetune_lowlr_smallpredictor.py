...
class Config:
    ...
    def __init__(self):
        ...
        self.qlib_data_path = "/hdd1/zzr/qlib_data/dataForPKU/"
        self.instrument = 'all'
        ...
        # self.run_id = "backtest_20251126_1117_with_finetune_predictor_demo_test_20251115_0229_finetune_lowlr_smallpredictor"
        self.run_id = "backtest_20251128_0003_val_with_finetune_predictor_demo_test_20251115_0229_finetune_lowlr_smallpredictor"
        ...
        self.backtest_time_range = ["2022-09-01", "2025-11-06"]

        # TODO: Directory to save the processed, pickled datasets.
        self.dataset_path = "./data/processed_datasets_origin_6"
        ...
        self.tokenizer_learning_rate = 0.000050
        ...
        self.pretrained_tokenizer_path = "./outputs/models/finetune_tokenizer_demo_test_20251123_1852_new-model-params-5/checkpoints/best_model"
        ...
        self.finetuned_predictor_path = f"{self.save_path}/finetune_predictor_demo_test_20251115_0229_finetune_lowlr_smallpredictor/checkpoints/best_model"
        self.finetuned_tokenizer_path = "NeoQuasar/Kronos-Tokenizer-base"
        # self.finetuned_predictor_path = "NeoQuasar/Kronos-base"
        # self.finetuned_tokenizer_path = "./outputs/models/finetune_predictor_demo_test_20251115_0229_finetune_lowlr_smallpredictor/checkpoints/best_model"
