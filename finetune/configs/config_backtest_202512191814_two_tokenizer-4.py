...
class Config:
    ...
    def __init__(self):
        ...
        self.run_id = "backtest_202512191814_two_tokenizer-4"
        ...
        self.output_feature_list = ['open', 'high', 'low', 'close', 'vol', 'amt']
        ...
        self.predictor_learning_rate = 5e-6
        ...
        # Miscellaneous
        self.seed = 200  # Global random seed for reproducibility.
        ...
        self.output_tokenizer_model_initialize_params = {
            "attn_dropout_p": 0.0,
            "beta": 0.05,
            "d_in": 6,
            "d_model": 512,
        ...
        self.pretrained_output_tokenizer_path = "NeoQuasar/Kronos-Tokenizer-base"
        ...
        self.finetuned_output_tokenizer_path = "NeoQuasar/Kronos-Tokenizer-base"
        ...
        self.finetuned_predictor_path = "./outputs/models/finetune_predictor_demo_test_202512190216_two_tokenizer-3/checkpoints/best_model"
