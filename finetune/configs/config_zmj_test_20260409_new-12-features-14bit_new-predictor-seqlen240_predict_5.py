...
class Config:
    ...
    def __init__(self):
        ...
        self.run_id = "zmj_test_20260409_new-12-features-14bit_new-predictor-seqlen240_predict_5"
        ...
        self.lookback_window = 240  # Number of past time steps for input.
        ...
        self.batch_size = 500  # Batch size per GPU.
        ...
        self.predictor_learning_rate = 8e-5
